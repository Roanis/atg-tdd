...
4. See the Core [build file](https://github.com/Roanis/atg-tdd/blob/master/Core/build.gradle) for which transitive dependencies are needed and add those to your project/build.
